...
export const BlueCircle = tw.div`
    absolute z-30 w-16 h-16 bg-white border-2 border-pokedex-border rounded-full top-4 mt-0.5 left-10 flex items-center justify-center
